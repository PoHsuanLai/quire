...
| Grid | 2 columns, gap 8, padding 12; module tiles `--r-tile` 12; sliders span both columns | proposed; built 2026-09-25 as `ModuleGrid` (the columns and gap; the panel keeps the padding) of `ModuleTile` (`TileSpan::Full` spans both columns), sill Q78 |
